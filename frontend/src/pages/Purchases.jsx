  ...
  const filteredPurchases = useMemo(() => {
    return purchases.filter((purchase) => {
      ...
      const startDateMatch =
        !historyFilters.startDate || purchaseDate >= historyFilters.startDate;

      const endDateMatch =
        !historyFilters.endDate || purchaseDate <= historyFilters.endDate;
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <div>
          <h1>Purchases</h1>
          <p>Record and review equipment purchases</p>
        </div>
      </div>
      ...
      <div className="table-card">
        <div className="table-header">
          <div>
            ...
            <p>{filteredPurchases.length} record(s)</p>
          </div>
        </div>
              ...
              <tbody>
                {filteredPurchases.map((purchase) => (
                  <tr key={purchase.id}>
                    ...
                    <td>{purchase.Base?.name || "Unknown"}</td>

                    <td>{purchase.EquipmentType?.name || "Unknown"}</td>
